...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = CustomUser
        fields = ['username', 'email', 'first_name', 'last_name', 'mobile', 'gender', 'department_id']
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = CustomUser
        fields = ['email', 'first_name', 'last_name','mobile', 'gender', 'department_id']
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('username', 'first_name', 'last_name', 'mobile', 'is_superuser', 'admin', 'id' , 'department_id')
    list_filter = ( )
    ...
    fieldsets = (
        ...
        ('Profile', {'fields': (
            'first_name', 'last_name', 'mobile', 'email', 'gender', 'department_id'
        )}),
        ('Permissions', {'fields': (
    ...
    add_fieldsets = (
        ...
        ('Profile', {'fields': ('first_name', 'last_name', 'mobile', 'email', 'gender', 'department_id')}),
    )
